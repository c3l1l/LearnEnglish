...
using LearnEnglish.ModelConfig;
...
namespace LearnEnglish.Models
{
    public class LearnEnglishContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration<Theme>(new ThemeCFG());
            modelBuilder.ApplyConfiguration<Section>(new SectionCFG());
            modelBuilder.ApplyConfiguration<Category>(new CategoryCFG());
            modelBuilder.ApplyConfiguration<Instruction>(new InstructionCFG());
            modelBuilder.ApplyConfiguration<Content>(new ContentCFG());
